...
export default function Tutorial() {
  ...
  const steps = [
    ...
    {
      selector: '.bottom',
      content: 'Your tiles are at the bottom of the screen. The first row contains your flowers, the second row contains any open melds you have made and the last row contains your hidden hand.',
      stepInteraction: false,
    },
    {
      selector: '.status',
      content: "The top left shows what is currently happening in the game. It's your turn to draw!",
      stepInteraction: false,
    },
    {
      selector: '#buttonDraw',
    ...
    {
      selector: '.bottom',
      content: "Now it's time to discard a tile. Let's discard the 🀃 we just drew. Click on it to discard it.",
      action: () => {
        setNonce(nonce + 1);
        setHideNextButton(true);
      }
    ...
    {
      selector: '.discards',
      content: "The tile you discarded is added to the discard pile, and it becomes the next player's turn. Let's see what they discard.",
      stepInteraction: false,
      position: 'top'
    },
    {
    ...
    {
      selector: '#buttonHu',
      content: 'Click the "Declare win" button to arrange our tiles into a winning hand.',
      action: () => {
        setHideNextButton(true);
      },
      position: 'top'
    ...
    {
      selector: '.bottom',
      content: 'Most of our hand is already revealed. We just need to select our last 🀟🀠🀡 meld.'
    },
    {
      content: 'You won!'
    }
  ...
  return <div onClick={bubbleCatcher}>
    ...
    <Tour
        ...
        lastStepNextButton={<button onClick={() => history.push('/')}>Finish tutorial</button>}
